...
//        System.out.println("浅copy。。。。。end");
        ...
        Student stuDe = CloneUtils.clone(stuDirect);
        System.out.println("stuDirect:"+stuDirect+" stuDirect.teacher: "+stuDirect.getTeacher()+" stuDirect.name: "+stuDirect.getName());
        System.out.println("stuDe:"+stuDe+" stuDe.teacher: "+stuDe.getTeacher()+" stuDe.name: "+stuDe.getName());
        System.out.println("浅copy引用重新赋值。。。。。");
        stuDe.setTeacher(new Teacher());
        stuDirect.setName("123");
        System.out.println("stuDirect:"+stuDirect+" stuDirect.teacher: "+stuDirect.getTeacher()+" stuDirect.name: "+stuDirect.getName());
        System.out.println("stuDe:"+stuDe+" stuDe.teacher: "+stuDe.getTeacher()+" stuDe.name: "+stuDe.getName());
